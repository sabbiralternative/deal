...
const WhatsApp = () => {
  ...
  return (
    <>
      ...
      <div className="social-fab social-fab--whatsapp">
        {Settings?.instagramLink ? (
          <div
            ...
            className=" "
          >
            <div className="social-fab__icon-wrap">
              <img className="social-fab__icon" src={images.instagram} alt="" />
            </div>
          </div>
        ) : null}
        {Settings?.telegramLink ? (
          ...
          >
            <div className="social-fab__icon-wrap">
              <img className="social-fab__icon" src={images.telegram} alt="" />
            </div>
          </div>
        ) : null}
        {Settings?.whatsapplink || Settings?.branchWhatsapplink ? (
          <div onClick={navigateWhatsApp} title="WhatsAppContact" className=" ">
            <div className="social-fab__icon-wrap">
              <svg
                width="49"
                height="49"
